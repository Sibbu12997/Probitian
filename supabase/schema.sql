-- ============================================================
-- ProBItian FULL STACK CMS - SUPABASE DATABASE SCHEMA
-- Production-Ready Relational Database with RLS & Seed Data
-- ============================================================
...
-- 12. PAGES CONFIGURATION TABLE (Home Page, About Page, etc.)
...
-- 1. WEBSITE GENERAL SETTINGS SEED
...
-- 5. HOME PAGE CONFIGURATION SEED
...
CREATE POLICY "Public storage access" ON storage.objects FOR SELECT USING (bucket_id IN ('media', 'projects', 'blogs', 'settings'));
