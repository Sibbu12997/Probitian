...
<p style="text-align: center; margin: 30px 0;">
  <a href="https://probitian.com/contact" style="background-color: #7c3aed; color: #ffffff; padding: 14px 28px; border-radius: 8px; font-weight: bold; text-decoration: none; display: inline-block;">Schedule 15-Min Power BI Discovery Call &rarr;</a>
</p>
<p>Best regards,<br />
...
<a href="https://probitian.com" style="color: #7c3aed; font-size: 13px;">probitian.com</a></p>`
  },
  {
...
<p style="text-align: center; margin: 28px 0;">
  <a href="https://probitian.com/projects" style="background-color: #0f172a; color: #f59e0b; padding: 14px 28px; border-radius: 8px; font-weight: bold; text-decoration: none; display: inline-block; border: 1px solid #f59e0b;">View Manufacturing Case Studies &rarr;</a>
</p>
<p>Warm regards,<br />
<strong>Shivam</strong><br />
Lead Power BI Architect | ProBitian<br />
<span style="color: #64748b; font-size: 13px;">Direct: +91 98260 00000 | shivam@probitian.com</span></p>`
  },
  {
...
<p style="text-align: center; margin: 28px 0;">
  <a href="https://probitian.com/contact" style="background-color: #7c3aed; color: #ffffff; padding: 14px 28px; border-radius: 8px; font-weight: bold; text-decoration: none; display: inline-block;">Request Financial BI Demo &rarr;</a>
</p>
<p>Best regards,<br />
<strong>ProBitian BI Solutions Team</strong><br />
<a href="https://probitian.com" style="color: #7c3aed;">probitian.com</a></p>`
  }
];
              ...
              {activeTab === 'write' ? (
                <div className="space-y-5">
                  ...
                  <div className="flex flex-wrap items-center gap-1.5 p-2 rounded-xl bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-xs">
                    ...
                    <button
                      type="button"
                      onClick={() => handleInsertHtmlSnippet('<p style="text-align: center; margin: 28px 0;"><a href="https://probitian.com/contact" style="background-color: #7c3aed; color: #ffffff; padding: 12px 24px; border-radius: 8px; font-weight: bold; text-decoration: none; display: inline-block;">Schedule Consultation &rarr;</a></p>')}
                      className="px-2.5 py-1 rounded-lg bg-white dark:bg-slate-700 hover:bg-slate-100 dark:hover:bg-slate-600 font-bold text-[11px] flex items-center gap-1 border border-slate-200 dark:border-slate-600"
                    >
